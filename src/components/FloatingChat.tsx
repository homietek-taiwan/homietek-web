...
const N8N_WEBHOOK_URL = process.env.NEXT_PUBLIC_N8N_WEBHOOK_URL || 'https://way-belly-inbox-sailing.trycloudflare.com/webhook/homietek-chat';
const N8N_POLL_URL = process.env.NEXT_PUBLIC_N8N_POLL_URL || 'https://way-belly-inbox-sailing.trycloudflare.com/webhook/homietek-chat-poll';
